                ...
                if (connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        using (SqlCommand checkUsername = new SqlCommand(selectUsername, connect))
                        {
                            ...
                            else if (register_password.TextLength < 8)
                            {
                                MessageBox.Show("Invalid Password, at least 8 charcters are needed", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }
                            else
                            {
